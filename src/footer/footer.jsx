      ...
      <div className="container">
        <div className="row py-5 gy-5 ">
          <div className="col-lg-4 text-white">
            ...
            <div class="row">
  <div class="col">
    <input type="text" class="form-control" placeholder="Enter Your Email*" aria-label="First name" />
  </div>
  
</div>
<div className="footerbtn-box">
<a href="#" className='footer-btn'>Subscribe</a>
</div>
          </div>
          <div className="col-lg-4 col-md-6 text-white text-md-end text-center">
            
            <p className="text-md-end text-center"><strong>MOBIRISE</strong>
            </p>
            ...
            <div className="footer-socialLinks ">
              ...
              <a href="#"><span><i class="bi bi-telegram"></i></span></a>
            </div>
          </div>
          <div className="col-lg-4 col-md-6 text-white text-md-end text-center">
